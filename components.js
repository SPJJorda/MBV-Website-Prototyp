...
export const WorkPartner = () => `
  <section class="work-partner" aria-labelledby="work-partner-title">
    <div class="work-partner__visuals" aria-label="Vorgesehene Plätze für Portrait- oder Teambilder des Freiburger Münsterbauvereins">
      <img class="work-partner__image work-partner__image--large reveal" src="${asset("mbv-turm-1.webp")}" alt="Restauriertes Maßwerk am Freiburger Münsterturm" loading="lazy" />
      <img class="work-partner__image work-partner__image--small reveal" src="${asset("mbv-turm-2.webp")}" alt="Gemeinsames Engagement für das Freiburger Münster" loading="lazy" />
    </div>
  ...
  <footer class="footer" id="kontakt">
    <div class="shell"><div class="footer__brand-lockup"><img class="footer__logo" src="${asset("logo-mark.svg")}" alt="Unser Turm" width="239" height="113" /><img class="footer__partner-logo" src="${asset("mbv-logo-negative.png")}" alt="Freiburger Münsterbauverein e. V." width="531" height="342" /></div>
      <div class="footer__grid">
        <div class="footer__contact"><h2>Kontakt</h2><address>Freiburger Münsterbauverein e. V.<br />Schoferstraße 4<br />79098 Freiburg<br />Tel. 0761 214027-0<br /><a href="mailto:info@muensterbauverein-freiburg.de">info@muensterbauverein-freiburg.de</a><a href="https://www.muensterbauverein-freiburg.de" target="_blank" rel="noopener noreferrer">www.muensterbauverein-freiburg.de</a></address><nav class="footer__legal" aria-label="Rechtliche Hinweise"><a href="https://www.muensterbauverein-freiburg.de/impressum/" target="_blank" rel="noopener noreferrer">Impressum</a><a href="https://www.muensterbauverein-freiburg.de/datenschutzseite/" target="_blank" rel="noopener noreferrer">Datenschutz</a></nav></div>
