...
const SelectPanel = () => `
  <section class="flow-panel flow-panel--select is-active" data-flow-panel="0" aria-labelledby="select-title">
    <header class="flow-heading"><h2 id="select-title">Wählen Sie Ihren Stein</h2><span>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor.</span></header>
    ${StoneMap()}
...
const FormPanel = () => `
  <section class="flow-panel flow-panel--form" data-flow-panel="1" aria-labelledby="form-title" hidden>
    <header class="flow-heading"><h2 id="form-title">Formular ausfüllen</h2><span>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor.</span></header>
...
const PaymentPanel = () => `
  <section class="flow-panel flow-panel--payment" data-flow-panel="2" aria-labelledby="payment-title" hidden>
    <header class="flow-heading"><h2 id="payment-title">Zahlungsart wählen</h2><span>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor.</span></header>
...
const PatronageApp = () => `
  <section class="patron-app" id="patenschaft" aria-label="Steinpatenschaft konfigurieren">
    <aside class="patron-app__rail"><div><h2 class="brush-title"><span>Jeder Stein</span><span>zählt!</span></h2><p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr.</p></div>${FlowSteps()}<div class="rail-pixels" aria-hidden="true"></div></aside>
